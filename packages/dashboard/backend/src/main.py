...
app.add_middleware(CORSMiddleware, allow_origins=["http://localhost:8712", "http://127.0.0.1:8712", "http://localhost:8713", "http://127.0.0.1:8713", "http://localhost:5173", "http://127.0.0.1:5173"], allow_methods=["*"], allow_headers=["*"])
